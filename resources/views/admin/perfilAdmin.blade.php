                ...
                <div class="col-sm-4 col-md-4 col-lg-4">
                    <form name="perfil" action="perfilAd" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <label for="telefono">
                                Móvil 1
                                <input type="tel" id="telefono" name="telefono" value="<?php echo $telefono ?>" placeholder="Telefono" pattern="[9]{1}[0-9]{8}"><br>
                            </label>
                            <label for="movil">
                                Móvil 2
                                <input type="tel" id="movil" name="movil" value="<?php echo $movil ?>" placeholder="Movil" pattern="[6-7]{1}[0-9]{8}"><br>
                            </label>
