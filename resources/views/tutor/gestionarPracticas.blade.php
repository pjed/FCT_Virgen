                        ...
                        <tr>
                            ...
                            <td>
                                <select name="idResponsable">
                                    ...
                                    foreach ($l3 as $k3) {
                                        ?>
                                        <option value="<?php echo $k3->id; ?>" <?php if ($key['responsables_id'] == $k3->id) { ?> selected<?php } ?>><?php echo $k3->nombre . ', ' . $k3->apellidos; ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                            ...
                            <td>
                                <label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm col-md col-lg">
                                            <input type="text" id="recibiFCT" class="btn btn-primary" name="recibiFCT" value="Anexo V Recibí FCT"/>
                                        </div>
                                        <div class="col-sm col-md col-lg">
                                    ...
                                    <div class="row">
                                        <div class="col-sm col-md col-lg">
                                            <input type="text" id="recibiFPDUAL" class="btn btn-primary" name="recibiFPDUAL" value="Anexo XV Recibí FP DUAL"/>
                                        </div>
                                        <div class="col-sm col-md col-lg">
