...
select  datAlumnos.DNI, 
		...
		'09bb18760766d98eed9f056f641276745a43155e89cada2c6c82ab0dc62d4775' as pass, 
        datAlumnos.TELEFONO, 
        datAlumnos.MOVIL, 
        null as iban,  
        now(), 
...
/* Sentencia para insertar empresas de prueba */
...
values(null, 'A28599033','Indra Sistemas',null,null,'Avenida de Bruselas nº 35','Alcobendas',null,0,now(),now());

insert into empresas(id, cif, nombre, dni_representante, nombre_representante, direccion, localidad, horario, nueva, created_at, updated_at)
values(null, 'B83028084','Deimos Space',null,null,'Ronda de Poniente 19, – 28760','Tres Cantos',null,0,now(),now());

insert into empresas(id, cif, nombre, dni_representante, nombre_representante, direccion, localidad, horario, nueva, created_at, updated_at)
values(null, 'B82387770','Everis',null,null,'Camino de la Fuente de la Mora, 1','Madrid',null,0,now(),now());

insert into empresas(id, cif, nombre, dni_representante, nombre_representante, direccion, localidad, horario, nueva, created_at, updated_at)
values(null, 'A28855260','IECISA',null,null,'C/ Hermosilla 112','Madrid',null,0,now(),now());
